...
<ul>
        ...
        <li>
       <a href="#" class="mission"> Mission News</a>
        </li>
        
        <li>
       <a href="#" class="fundraiser"> Fundraiser</a>
        </li>
        
        <li>
       <a href="#" class="prize_program"> Prize Program</a>
        </li>
        
        <li>
       <a href="#" class="food_games_nav"> Food Games</a>
        </li>
        
        <li>
       <a href="#" class="qa_nav"> Q & A</a>
        </li>
        
        <li>
       <a href="#" class="contact_us_nav"> Contact us</a>
        </li>
